...
export const FARM_TIME_ADDRESS: { [chainId: number]: string } = {
    [ChainId.ETHEREUM]: "0x1c3000b8f475A958b87c73a5cc5780Ab763122FC",
    [ChainId.BSC]: "0x2c6dcEd426D265045737Ff55C2D746C11b2F457a",
    [ChainId.OPTIMISM]: "0x4DeA9e918c6289a52cd469cAC652727B7b412Cd2",
    [ChainId.OPTIMISM_KOVAN]: "0xE1943274700e3006E0BDB234786cDE24e792BB41",
...
export const POOL_ADDRESS: { [tokenSymbol in TokenSymbol]: { [chainId: number]: string } } = {
    ...
    [TokenSymbol.USDT]: {
        ...
        [ChainId.GOERLI]: "0x72953618D63C588876dBA7b6B4ECA0E4702518ca",
...
export const USDT_ADDRESS: { [chainId: number]: string } = {
    ...
    [ChainId.GOERLI]: "0x5BCc22abEC37337630C0E0dd41D64fd86CaeE951",
    ...
    // [ChainId.OPTIMISM_GOERLI]: "0xc57C46d47FD79596F2B2Af83291392229313D095",
    [ChainId.FANTOM]: "0x0000000000000000000000000000000000000000",
    [ChainId.FANTOM_TESTNET]: "0x4a4129978218e7bac738D7B841D3F382D6EFbeE9",
}

export const USDT_METIS_ADDRESS: { [chainId: number]: string } = {
    ...TEST.USDT_ADDRESS,
    [ChainId.ETHEREUM]: "0xdac17f958d2ee523a2206206994597c13d831ec7",
    [ChainId.GOERLI]: "0x5BCc22abEC37337630C0E0dd41D64fd86CaeE951",
    [ChainId.METIS]: "0xbB06DCA3AE6887fAbF931640f67cab3e3a16F4dC",
    [ChainId.METIS_TESTNET]: "0x4632b54146C45Cf31EE1d5A1191260Af7e9DB801",
    [ChainId.BSC]: "0x55d398326f99059fF775485246999027B3197955",
    [ChainId.BSC_TESTNET]: "0xF49E250aEB5abDf660d643583AdFd0be41464EfD",
    [ChainId.AVALANCHE]: "0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7",
    [ChainId.FUJI]: "0x134Dc38AE8C853D1aa2103d5047591acDAA16682",
