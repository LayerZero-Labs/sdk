...
describe('Price', () => {
  ...
  const t0 = new Token(1, ADDRESS_ZERO, 18, TokenSymbol.USDC)
  const t0_6 = new Token(1, ADDRESS_ZERO, 6, TokenSymbol.USDC)
  const t1 = new Token(1, ADDRESS_ONE, 18, TokenSymbol.USDC)
